#ifndef CAFFE_SCALEINVARIANTBERHU_LOSS_LAYER_HPP_
#define CAFFE_SCALEINVARIANTBERHU_LOSS_LAYER_HPP_
...
class ScaleInvariantBerhuLossLayer : public LossLayer<Dtype> {
 public:
  explicit ScaleInvariantBerhuLossLayer(const LayerParameter& param)
...
#endif  // CAFFE_SCALEINVARIANTBERHU_LOSS_LAYER_HPP_
