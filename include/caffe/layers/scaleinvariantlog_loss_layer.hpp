#ifndef CAFFE_SCALEINVARIANTLOG_LOSS_LAYER_HPP_
#define CAFFE_SCALEINVARIANTLOG_LOSS_LAYER_HPP_
...
class ScaleInvariantLogLossLayer : public LossLayer<Dtype> {
 public:
  explicit ScaleInvariantLogLossLayer(const LayerParameter& param)
...
#endif  // CAFFE_SCALEINVARIANTLOG_LOSS_LAYER_HPP_
