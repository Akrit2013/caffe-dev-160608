#ifndef CAFFE_CRF2_LOSS_LAYER_HPP_
#define CAFFE_CRF2_LOSS_LAYER_HPP_
...
class Crf2LossLayer : public LossLayer<Dtype> {
 public:
  explicit Crf2LossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "Crf2Loss"; }
  /**
   * Unlike most loss layers, in the Crf2LossLayer we can backpropagate
 ...
 protected:
  ...
  Dtype alpha_;
  // The base learning rate of the crf weight
  Dtype beta_;
  // The gamma param for R
  Dtype gamma_;
...
#endif  // CAFFE_CRF2_LOSS_LAYER_HPP_
