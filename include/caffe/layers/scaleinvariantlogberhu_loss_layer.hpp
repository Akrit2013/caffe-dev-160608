#ifndef CAFFE_SCALEINVARIANTLOGBERHU_LOSS_LAYER_HPP_
#define CAFFE_SCALEINVARIANTLOGBERHU_LOSS_LAYER_HPP_
...
// Added by YanHan
// This loss layer is introduced by Eigen NIPS2014
...
class ScaleInvariantLogBerhuLossLayer : public LossLayer<Dtype> {
 public:
  explicit ScaleInvariantLogBerhuLossLayer(const LayerParameter& param)
 ...
 protected:
  ...
  // Blob to store the log scale prediction
  Blob<Dtype> pred_log_;
  // Blob to store the log scale label
  Blob<Dtype> label_log_;
  ...
  // The c_rate_ between 0 and 1
  Dtype		c_rate_;
  Dtype		c_boundary_;
  // The h_rate_ normally larger than 1
  Dtype		h_rate_;
  bool		has_h_rate_;
};
...
#endif  // CAFFE_SCALEINVARIANTLOGBERHU_LOSS_LAYER_HPP_
